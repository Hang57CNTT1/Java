...
public class DanhMucKhachHang extends javax.swing.JFrame {
    ...
    public DanhMucKhachHang() {
        initComponents();
         tableKhachhang.setModel(XuLyNV.KhachModel());
    }
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
       ...
       int thucThi = XuLyNV.UpdateKhach(txtMaKhach.getText(), txtTenKhach.getText(), txtDiaChi.getText(), txtDienThoai.getText());
        if(thucThi == 0){
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
         int thucThi = XuLyNV.InsertKhach(txtMaKhach.getText(), txtTenKhach.getText(), txtDiaChi.getText(), txtDienThoai.getText());
        if(thucThi == 0){
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        ...
        String MaKhach = XuLyNV.KhachModel().getValueAt(n, 0).toString();
        int thucThi = XuLyNV.DeleteKhach(MaKhach);
        if(thucThi == 0){
